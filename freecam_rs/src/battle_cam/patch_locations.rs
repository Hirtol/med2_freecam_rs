...
pub const PATCH_LOCATIONS_STEAM: [usize; 74] = [
    ...
    0x008F8E1C, 0x008F8B5C, 0x00E7EF7F, 0x0094FCE5, 0x008FAC72, 0x008F8C76, 0x008F9443, 0x0095B429,
    ...
    0x0095B499, // Unit panning Z, don't bother blocking that!
    // 0x0095B7FC,
    // 0x008F8E91,
    0x008F6F2F, 0x0095B3B5, 0x008F9011, // Target X
    0x008F8B78, 0x008F8E38, // Unit panning X, special patch
    // 0x008F8EB9,
    0x00E7EF91, 0x008F6F5F, 0x0095B5CB, 0x0094FB90, 0x0095B828, 0x008F8CB6, 0x008F9480, 0x008F7056,
    0x008FAC5B, // Target Y
    0x008F8B84, 0x008F8E44, // Unit panning Y, special patch
    // 0x008F8EC5,
    0x00E7EFA6, 0x008F6F6B, 0x0095B5D4, 0x0094FB9B, 0x0095B831, 0x008F8CC0, 0x008F948A, 0x008F7060,
    0x008FAC63, // Target Z
    0x008F8B7E, 0x008F8E3E, // Unit panning Z, special patch
    // 0x008F8EBF,
    0x00E7EF9B, 0x008F6F65, 0x0095B5CF, 0x0094FB95, 0x0094FBCE, 0x0094FDCD, 0x0095B82C, 0x008F8CBB, 0x008F9485,
